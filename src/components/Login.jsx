        ...
        <div className='h-[calc(100vh-120px)] flex justify-center items-center'>
            <div className='w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4'>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className='mb-4'>
                        <label className='block text-gray-700 text-sm fonnt-bold mb-2' htmlFor="email">Email</label>
                ...
                <p className='mt-5 text-center text-gray-500 text-xs'>2025 Book Store . All Rights reversed</p>
            </div>
        </div>
    )
}
